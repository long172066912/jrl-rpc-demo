...
public class RpcInvoker {
    ...
    private static final Map<String, RpcCluster<Object>> FAULT_TOLERANT_MAP = new ConcurrentHashMap<>();
    ...
    public static Object invoke(RpcRequest request) throws Exception {
        //1 获取容错
        RpcCluster<Object> faultTolerant = FAULT_TOLERANT_MAP.get(request.getCluster());
